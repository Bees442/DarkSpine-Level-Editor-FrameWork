...
/// @param text array2d
/// Same visual language as dks_draw_button_reel, for reels whose labels come
/// from a separate parallel array.
function dks_draw_button_array(argument0, argument1)
{
	...
	for (var i = 0; i < s; i++)
	{
	 ...
	 draw_text(x1 + global.ui_stripe + global.ui_pad, (y1+y2)*0.5, l[i][10]);
	}
